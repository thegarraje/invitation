...
export function FooterSection({ footer }: FooterSectionProps) {
  return (
    <footer id={footer.id} className="relative px-6 pb-44 pt-16">
      <div className="mx-auto max-w-6xl rounded-[2rem] border border-white/10 bg-black/25 p-8 text-[#ebf9fa] backdrop-blur-sm">
