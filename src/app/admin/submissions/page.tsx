    ...
    <main className="min-h-screen bg-[#ebf9fa] px-4 py-8 text-[#3a001a]">
      <div className="mx-auto w-full max-w-6xl rounded-[1.4rem] border border-black/10 bg-white p-6 shadow-xl md:p-8">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-black/55">Admin Panel</p>
            <h1 className="mt-2 text-2xl font-semibold md:text-3xl">NDA Confirmations</h1>
            <p className="mt-2 text-sm text-black/70">
              Records captured from the new confirm flow. Latest submissions appear first.
            </p>
          </div>
